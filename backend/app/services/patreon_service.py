...
class PatreonService:
    ...
    def get_campaigns(self) -> List[Dict]:
        ...
        params = {
            "fields[campaign]": "creation_name,url,patron_count,published_at"
        }
    ...
    def fetch_posts_with_gallery_dl(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            cmd = [
                ...
                '--option', f'extractor.patreon.api-token={self.access_token}',
            ...
            if session_id:
                ...
                if chrome_profile:
                    browser_spec = f'chrome:{chrome_profile}' if chrome_profile != 'Default' else 'chrome'
                    cmd.extend([
                    ...
                    print(f"[GALLERY-DL] WARNING: No Patreon cookies detected, trying default Chrome profile")
            ...
            print(f"[GALLERY-DL] Successfully parsed {len(posts)} unique posts from {len(json_files)} files")
            return posts
    ...
    def download_post_images(
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            cmd = [
                ...
                '--option', f'extractor.patreon.api-token={self.access_token}',
                '--option', f'base-directory={temp_dir}',
                '--filter', f'id == "{post_id}"',  # Only this post
