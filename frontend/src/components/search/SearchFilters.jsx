        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {searchParams.characters.map((char, idx) => (
              <span
                key={idx}
                className="inline-flex items-center gap-1 px-3 py-2 bg-blue-100 text-blue-800 rounded-full text-sm"
              >
                {char}
                <button
                  onClick={() => removeFilter("characters", char)}
                  className="hover:text-blue-600 p-1 -mr-1 min-w-[24px] min-h-[24px] flex items-center justify-center"
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mt-2">
            {searchParams.tags.map((tag, idx) => (
              <span
                key={idx}
                className="inline-flex items-center gap-1 px-3 py-2 bg-purple-100 text-purple-800 rounded-full text-sm"
              >
                {tag}
                <button
                  onClick={() => removeFilter("tags", tag)}
                  className="hover:text-purple-600 p-1 -mr-1 min-w-[24px] min-h-[24px] flex items-center justify-center"
