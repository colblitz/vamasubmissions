    ...
    >
      ...
      {hasUnsavedChanges && (
        <div className="absolute top-10 right-2 z-10">
          <span className="px-2 py-1 bg-amber-500 text-white text-xs font-semibold rounded shadow-lg flex items-center gap-1">
      ...
      <div className="p-3 flex-1 flex flex-col">
        ...
        <div className="grid grid-cols-2 gap-2">
          <button
            ...
            className="px-3 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed text-xs font-medium"
            title="Save changes"
          >
            Save
          </button>
